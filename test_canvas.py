...
def test_submit_assignment(mock_print, arranged_assignment, arranged_submission):
    ...
    arranged_assignment.submit("goofy")
...
def test_import_students(mock_print, arranged_course, arranged_user):
    ...
    assert arranged_course.student_list[0].name == "Gabe Karras"
...
def test_find_a_course(mock_print, arranged_courseManager, arranged_user):
    ...
    arranged_courseManager.find_a_course("goofy")
...
def test_create_a_user(mock_print, mock_generate_id, arranged_userManager):
    # Act:
    arranged_userManager.create_a_user("Gabe Karras", "1234", "Student")
    arranged_userManager.create_a_user(42, "goofy", "goofy")
...
def test_find_users(mock_print, arranged_userManager):
    # Act:
    arranged_userManager.create_a_user("Gabe Karras", "1234", "Student")
    arranged_userManager.create_a_user("Kevin Diehr", "12345", "Student")
